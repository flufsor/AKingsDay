...
{
    public class OneShot : IShowable
    {
        ...
        public OneShot(Texture2D spriteSheet, int rowOffset, int frameCount, int width, int height, int fps, int spacing = 5, SpriteEffects effects = SpriteEffects.None)
        {
        ...
        public OneShot(Texture2D spriteSheet, int rowHeight, int frameCount, int width, int height, int fps, int spacing = 5, int startAnimationFrame = 0, SpriteEffects effects = SpriteEffects.None) : this(
